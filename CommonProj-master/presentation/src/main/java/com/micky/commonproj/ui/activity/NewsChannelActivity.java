...
import com.micky.commonproj.ui.customview.DragView.DragAdapter;
import com.micky.commonproj.ui.customview.DragView.DragGrid;
import com.micky.commonproj.ui.customview.DragView.OtherAdapter;
import com.micky.commonproj.ui.customview.DragView.OtherGridView;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by dawn-pc on 2016/5/10.
 */
public class NewsChannelActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    private void initData() {
        ...
        userChannelList = daoSession.getChannelItemDao().queryRaw(" where selected = ?", new String[]{"1"});
        otherChannelList = daoSession.getChannelItemDao().queryRaw(" where selected = ?", new String[]{"0"});
...
//        getMenuInflater().inflate(R.menu.main, menu);
    ...
    private void saveChannel() {
        DaoSession daoSession = DBCore.getDaoSession();
        daoSession.getChannelItemDao().deleteAll();
