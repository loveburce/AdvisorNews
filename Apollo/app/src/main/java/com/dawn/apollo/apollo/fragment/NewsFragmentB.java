...
/**
 * Created by dawn-pc on 2016/4/7.
 */
public class NewsFragmentB extends Fragment implements CanRefreshLayout.OnRefreshListener, CanRefreshLayout.OnLoadMoreListener{
...
//    CanRVAdapter adapter;
    ...
    public static NewsFragmentB newInstance(int type) {
        NewsFragmentB fragment = new NewsFragmentB();
