...
import com.dawn.apollo.apollo.fragment.HotNewsFragmentA;

import java.util.ArrayList;
import java.util.List;

public class MainActivityB extends AppCompatActivity implements
        OnPageChangeListener, OnTabChangeListener {

    private FragmentTabHost mTabHost;
    private LayoutInflater layoutInflater;
    private Class fragmentArray[] = { HotNewsFragmentA.class, Fragment.class, Fragment3.class, Fragment4.class, Fragment4.class };
    ...
    private void initPage() {
        HotNewsFragmentA fragment1 = new HotNewsFragmentA();
